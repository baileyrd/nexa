...
expected={
 ...
 "nexa-headless": {"nexa-avatar", "nexa-domain", "nexa-knowledge", "nexa-knowledge-runtime", "nexa-nbp", "nexa-orchestrator", "nexa-orchestrator-runtime", "nexa-speech", "nexa-tutor", "tokio"},
}
