...
| G1 | Prove shared React/TypeScript/Vite + Tauri 2 candidate and versioned loopback HTTP/WebSocket suitability | Evidence satisfied; architecture selected |
| G2 | Prove bundled CPU speech candidate, including cancellation, devices, packaging, latency, and licensing | Continue; separately dispatchable bounded gate |
