...
- [x] opt-in availability-gated local, authorized available remote, and filtered authorized remote selection followed by exact tokenization, one selected-provider invocation, and strict admission
- [x] standalone optional reported input-usage reconciliation
- [x] opt-in reported-usage-validated exact-tokenization invocation and strict admission
- [x] opt-in explicit local-only selection followed by reported-usage-validated exact tokenization, one selected-provider invocation, and strict admission
