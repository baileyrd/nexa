...
| Requirement | Evidence | Status |
| --- | --- | --- |
| Exact ADR-0031 inputs and deterministic remote selection | `select_authorized_available_remote_model_invoke_and_admit`; focused `authorized_available_remote_invocation` order, insertion, denial, and non-consumption tests; ADR-0032 | Implemented slice |
