...
Manifest validation additionally requires glTF `-Z` forward convention and verifies the canonical armature, head, eye, and jaw names against the exported node inventory.
