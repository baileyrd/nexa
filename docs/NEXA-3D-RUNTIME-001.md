...
4. Add morph weights, animation sampler evaluation, and timeline UI. (Morph preview, clip-duration looping, and a renderer-neutral sampler with GLB linear/step transform-channel adaptation are available; cubic/multi-weight adaptation and GPU skinning remain pending.)
