...
3. Add skinning, joint visualization, and named node selection. (Rest-pose and headless-regression-tested sampled-clip joint visualization are available; mesh skinning and node selection remain pending.)
