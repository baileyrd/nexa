...
| 12 | NEXA-ORCH-001 | Session orchestration | Baseline Draft; ADR-0051 through ADR-0061 foundations and Behavior, Tutor Generation control, plus Retrieval bindings implemented | `nexa-orchestrator`; `nexa-orchestrator-runtime`; `apps/nexa-headless` |
