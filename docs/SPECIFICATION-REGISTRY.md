...
- [ADR-0036](adr/0036-provider-neutral-model-input-tokenization.md) records the separate synchronous provider-neutral model-input token-counting boundary and deterministic content-free replay evidence. Concrete tokenizers and integration into selection, validation, invocation, admission, or routing remain unimplemented; ADR-0022 and ADR-0027 conservative byte accounting is unchanged.
