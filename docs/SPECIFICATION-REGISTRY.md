...
| 09 | NEXA-SPCH-001 | Speech interaction | Baseline Draft; ADR-0062 asynchronous cancellation-control foundation implemented | `nexa-speech` |
...
| 12 | NEXA-ORCH-001 | Session orchestration | Baseline Draft; ADR-0051 through ADR-0062 foundations and Behavior, Tutor Generation control, plus Retrieval bindings implemented; Speech remains unbound | `nexa-orchestrator`; `nexa-orchestrator-runtime`; `apps/nexa-headless` |
