...
- `crates/nexa-orchestrator` owns dependency-light, synchronous session/workflow lifecycle and lifecycle-cancellation contracts. Runtime execution, subsystem adapters, async/task cancellation, networking, and persistence remain outside this boundary unless a later accepted decision assigns them.
